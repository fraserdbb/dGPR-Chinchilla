"""
Apoptosis Visualizer for Maxillary Incisor Fluence Simulation
...
def load_and_plot_zones():
    ...
    try:
        ...
        flux_cw = flux_raw.reshape((nx, ny, nz, nt), order='F').sum(axis=3)
    except Exception as e:
