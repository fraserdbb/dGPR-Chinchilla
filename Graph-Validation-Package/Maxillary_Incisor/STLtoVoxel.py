"""
STL to Voxel Converter for Maxillary Incisor Fluence Simulation
...
meshes = {
    ...
    8: trimesh.load('fiberCap.stl'),
}

# ~~~Mesh Labeling~~~
labeling_order = [3, 2, 4, 5, 6, 7, 8] # processes label order, later labels override prior labels
...
vol_mcx.flatten(order='F').astype(np.uint8).tofile(output_filename)
